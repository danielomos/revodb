...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("africa.revoenergy.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("africa.revoenergy.security.DomainUserDetailsService", "createSpringSecurityUser");
